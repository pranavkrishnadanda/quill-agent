"""E2E: POST /verify-code without auth token returns 401."""
...
def test_e2e_verify_code_without_auth_returns_401(greenmail: object) -> None:
    settings = Settings(
        imap_host="127.0.0.1",
    ...
    try:
        r = httpx.post(
            ...
            json={"service": "example", "since_seconds": 300},
        )

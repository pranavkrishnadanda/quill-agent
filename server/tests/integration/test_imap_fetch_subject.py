"""Integration test: fetch_message_by_uid returns the correct subject."""
...
def test_fetch_message_by_uid_returns_correct_subject(greenmail_clean) -> None:
    subject = "Please verify — code 314159"
    ...
    try:
        ...
        assert "Please verify" in fetched_subject
        assert "314159" in fetched_subject
    finally:

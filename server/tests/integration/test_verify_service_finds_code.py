"""Integration test: poll_for_verification finds a 6-digit code in a matching email."""
...
def test_poll_for_verification_returns_code(greenmail_clean) -> None:
    _send_mail(greenmail_clean, "Verify your account", "Your code is 456789")

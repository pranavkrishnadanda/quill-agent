"""Integration test: IMAP search returns UIDs in ascending order."""
...
def test_search_recent_uids_returns_sorted(greenmail_clean) -> None:
    for i in range(5):
        send_mail(greenmail_clean, f"subj-{i}")

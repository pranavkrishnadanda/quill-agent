"""Integration test: GET /health returns imap=connected with Greenmail up."""
...
def test_health_endpoint_reports_imap_connected(greenmail) -> None:
    settings = Settings(
        imap_host="127.0.0.1",
    ...
    assert response.json()["imap"] == "connected"

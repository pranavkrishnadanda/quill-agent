"""Integration test: sending three emails yields three UIDs in ascending order."""
...
def test_search_recent_uids_returns_three_uids_ascending(greenmail_clean) -> None:
    send_mail(greenmail_clean, "one")
    send_mail(greenmail_clean, "two")
    send_mail(greenmail_clean, "three")
